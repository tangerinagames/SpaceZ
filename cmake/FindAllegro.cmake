...
find_library(ALLEGRO_LIBRARY
    NAMES allegro allegro-5.0.4-mt
    HINTS ${ALLEGRO_LIBRARY_HINTS})

find_library(ALLEGRO_MAIN_LIBRARY
    NAMES allegro_main allegro_main-5.0.4-mt
    HINTS ${ALLEGRO_LIBRARY_HINTS})

find_library(ALLEGRO_FONT_LIBRARY
    NAMES allegro_font allegro_font-5.0.4-mt
    HINTS ${ALLEGRO_LIBRARY_HINTS})

find_library(ALLEGRO_AUDIO_LIBRARY
    NAMES allegro_audio allegro_audio-5.0.4-mt
    HINTS ${ALLEGRO_LIBRARY_HINTS})

find_library(ALLEGRO_ACODEC_LIBRARY
    NAMES allegro_acodec allegro_acodec-5.0.4-mt
    HINTS ${ALLEGRO_LIBRARY_HINTS})

find_library(ALLEGRO_IMAGE_LIBRARY
    NAMES allegro_image allegro_image-5.0.4-mt
    HINTS ${ALLEGRO_LIBRARY_HINTS})

find_library(ALLEGRO_TTF_LIBRARY
    NAMES allegro_ttf allegro_ttf-5.0.4-mt
    HINTS ${ALLEGRO_LIBRARY_HINTS})

find_library(ALLEGRO_PRIMITIVES_LIBRARY
    NAMES allegro_primitives allegro_primitives-5.0.4-mt
    HINTS ${ALLEGRO_LIBRARY_HINTS})
